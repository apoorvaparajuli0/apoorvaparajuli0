	...
	<body>
		<div itemscope itemtype="https://schema.org/Person" class="container-fluid p-0">
			...
			<div class="row text-light d-flex justify-content-center">
				<div class="col-12 text-center self-bio">
						...
						<div class="col-12">
							<div class="container-fluid px-3 text-light">
								<div class="row border border-1 border-light rounded-2 work-container-box">
									<div class="col-3 work-select-section text-center">
										...
										<div class="container-fluid">
											<div class="row p-0">
												<div class="col-12 p-0">	
													...
													<span class="badge skill-badge text-bg-secondary">React.js</span>
													<span class="badge skill-badge text-bg-secondary">Flask</span>
													<span class="badge skill-badge text-bg-secondary">AWS</span>
													<span class="badge skill-badge text-bg-secondary">nginx</span>
													<span class="badge skill-badge text-bg-secondary">Vercel</span>
													<span class="badge skill-badge text-bg-secondary">PostgreSQL</span>
													<span class="badge skill-badge text-bg-secondary">OpenAI API</span>
													<span class="badge skill-badge text-bg-secondary">Anthropic Claude</span>
													<span class="badge skill-badge text-bg-secondary">Google Analytics</span>
											...
											<div class="row p-0">
												<div class="col-12 p-0">
													<h5 id="community-support-group" itemprop="worksFor" class="fw-bolder">Community Support Group</h5>
													<span class="work-links">
														<a target="_blank" href="https://ncrhub.org">Web App</a>
													</span>
													<p class="work-time">August. 2023 - PRESENT</p>
													<p class="tools-used-title text-decoration-underline fw-bolder">Tools Used: </p>
													<span class="badge skill-badge text-bg-secondary">Next.js</span>
													<span class="badge skill-badge text-bg-secondary">Django</span>
													<span class="badge skill-badge text-bg-secondary">PostgreSQL</span>
													<span class="badge skill-badge text-bg-secondary">AWS</span>
													<span class="badge skill-badge text-bg-secondary">Vercel</span>
													<span class="badge skill-badge text-bg-secondary">Heroku</span>
													<span class="badge skill-badge text-bg-secondary">Groq</span>
													<span class="badge skill-badge text-bg-secondary">LangChain</span>
													<span class="badge skill-badge text-bg-secondary">nginx</span>
													<ul class="work-description-list">
														<li>
										...
										<div class="container-fluid">
											...
											<div itemscope itemtype="https://schema.org/Project" class="row p-0">
												<div class="col-12 p-0">	
													...
													<span class="badge skill-badge text-bg-secondary">Express</span>
													<span class="badge skill-badge text-bg-secondary">Next.js</span>
