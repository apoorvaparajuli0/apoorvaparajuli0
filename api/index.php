<?php 
	...
	$js_enabled_nonce = base64_encode(random_bytes(64));

	header("X-Frame-Options: SAMEORIGIN");
	header("Cross-Origin-Opener-Policy: same-origin");
	header("Content-Security-Policy: trusted-types default; require-trusted-types-for 'script'; default-src 'self'; connect-src https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js.map https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css.map; script-src 'self' 'nonce-$skill_filter_nonce' 'nonce-$clipboard_nonce' 'nonce-$color_theme_nonce' 'nonce-$google_script_nonce' 'nonce-$google_tag_nonce' 'nonce-$bootstrap_nonce'; style-src 'self' https://fonts.googleapis.com/ https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/; font-src https://fonts.gstatic.com/; media-src 'self'; base-uri 'self'");
...
<html lang="en">
	<head>
		...
		content=
		"
		Portfolio of Apoorva Parajuli, Full Stack Software Engineer specializing in 
		Django, React, Next.js, REST APIs, AI and LLM integrations, and scalable web 
		applications.
		"
		/>
		<meta name="keywords" content="Apoorva, Parajuli, Portfolio, Software, Engineer, Full, Stack, Backend, Frontend"/>
		...
		<!-- My Scripts -->
		 ...
		 <script <?php echo "nonce=\"$js_enabled_nonce\"" ?> async type="module" src="/js/js-enabled.js"></script>
		<!-- Google tag (gtag.js) -->
		...
		<div itemscope itemtype="https://schema.org/Person" class="container-fluid">
			<header>
				<div id="top" class="row d-flex justify-content-center">
					...
					<div class="col-12 col-md-6 text-center justify-content-center mt-3 d-flex align-items-center">
							<div class="container-fluid p-0">
								...
								<div class="row">
									<p class="set-text-color contact-info">
										<span id="email-link" class="cursor-pointer text-nowrap profile-link ms-1 me-1 mb-2">
											<span itemprop="email" class="text-decoration-underline">apoorvaparajuli@duck.com</span>
											<svg class="bi bi-clipboard email-copy" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
												<path d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1z"/>
												<path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0z"/>
											</svg>
										</span> | 
										<a aria-label="resume link" class="text-nowrap profile-link ms-1 me-1 mb-2" rel="noreferrer noopener" target="_blank" href="https://apoorvaparajuli.com/assets/Apoorva_Parajuli_Resume.pdf">
											<span>My Resumé</span>
										...
										<span id="phone-link" class="cursor-pointer text-nowrap profile-link ms-1 me-1 mb-2">
											<span class="text-decoration-underline" itemprop="telephone">(510) 374-9867</span>
											<svg class="bi bi-clipboard phone-copy" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
												<path d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1z"/>
												<path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0z"/>
											</svg>
										</span>
								...
								<div class="row">
									...
									<div class="col-12 d-flex justify-content-center">
										<p class="self-bio set-text-color" itemprop="description">
											I am a <span itemprop="jobTitle">Full Stack Software Engineer</span> specializing in Django, React, and 
											Next.js, building scalable web applications with a focus on API integration, performance, and accessible 
											user experiences. I work with modern development tools and AI-driven technologies to create efficient, 
							...
							<section>
								<div class="card work-cards">
									<div class="card-body set-text-color">
										...
										<h4 class="fs-6 degree-type fw-lighter">AI & Machine Learning Bootcamp</h4>
										<h4 class="fs-6 work-time">April 2025-Present</h4>
										<h4 class="fs-6 course-work-title">Relevant Coursework...</h4>
										<div class="container-fluid p-0">
											<div class="row">
										...
										<div class="relevant-links mt-5">
											<a aria-label="caltech website" target="_blank" href="https://www.caltech.edu/">Website</a>
										</div>
									</div>
								</div>
							</section>
							...
							<section>
								<div class="card work-cards">
									<div class="card-body set-text-color">
										...
										<h4 class="fs-6 degree-type fw-lighter">B.S. in Computer Science</h4>
										<h4 class="fs-6 work-time">August 2021-August 2023</h4>
										<h4 class="fs-6 course-work-title">Relevant Coursework...</h4>
										<div class="container-fluid p-0">
											<div class="row">
												<div class="col-12 set-text-color">
										...
										<div class="relevant-links mt-5">
											<a aria-label="usfca website" target="_blank" href="https://www.usfca.edu/">Website</a>
										</div>
									</div>
								</div>
							</section>
					...
					<div class="row work-row d-flex">
							...
							<section>
								<div class="card work-cards">
									<div class="card-body set-text-color">
										...
										<h4 class="fs-6 work-time">April 2024-October 2024</h4>
										<ul class="work-description">
											<li>
												Developed analytics dashboards to monitor application performance and site usage metrics using the Google Analytics API 
											</li>
											<li>
												Leveraged OpenAI and ClaudeAI APIs to process and structure text data, with a combination of prompt engineering and text processing techniques 
											</li>
											<li>
												Applied SwiftUI to implement web interface on iOS mobile devices and Swift tools to fetch and render data 
											</li>
											<li>
												Used Material UI components to develop a rich, responsive, and accessible web interface for prospective users 
											</li>
											<li>
												Improved SEO using tools such as schema.org microdata, and libraries that append unique meta tags to different pages (react-helmet) 
											</li>
											<li>
												Deployed application to AWS and Vercel, automated tasks such as running the application server and used the web server (nginx), openssl, and Certbot to proxy and authenticate requests 
											</li>
										</ul>
										<h4 class="fs-6 work-skills-title">Skills Used...</h4>
										<div class="container-fluid p-0">
											<div class="row">
												<div class="col-12 set-text-color">
													...
													<span class="badge skill-badge set-border-color">OpenAI API</span>
													<span class="badge skill-badge set-border-color">Claude API</span>
												</div>
											</div>
										</div>
										<div class="relevant-links mt-5">
											<a aria-label="web application for Polypinion" target="_blank" href="https://polypinion.com">Web App</a>
										</div>
									</div>
								</div>
							</section>
						...
						<div class="col-12 col-md-6 col-lg-6 p-0 p-md-3">
							<section>
								<div class="card work-cards">
									<div class="card-body set-text-color">
										<h3 class="fs-5 card-title">NCRHUB</h3>
										<h4 class="fs-6 work-time">August 2023-Present</h4>
										<ul class="work-description">
											<li>
												Used LangChain + LangGraph to orchestrate RAG app built on Pinecone vector database and an LLM hosted on generative model host Groq, as well as LangSmith to debug and resolve issues by analyzing the chain step-by-step 
											</li>
											<li>
												Leveraged Django/Django Rest Framework features such as caching, middleware, request throttling, streaming responses, and more to ensure a secure, efficient and user-friendly experience 
											</li>
											<li>
												Leveraged RabbitMQ w/ Celery to implement asynchronous task scheduling and queueing  
											</li>
											<li>
												Optimized site accessibility as per WCAG guidelines and responsiveness using tools ranging from Google Lighthouse and axe DevTools to Vercel web analytics 
											</li>
											<li>
												Worked to meet security standards by adopting strict Cross-Origin-Opener-Policy, Content Security Policy, and HSTS policy as well as implementing IP-address based rate-limiting/throttling and OIDC token authentication for client applications 
											</li>
											<li>
												Made use of map libraries to create an interactable map for easier user navigation of data, alongside custom react hooks and clustering algorithms integrated with the Supercluster library, and distance formulae such as Haversine 
											</li>
										</ul>
										<h4 class="fs-6 work-skills-title">Skills Used...</h4>
										<div class="container-fluid p-0 skills-container">
											<div class="row">
												<div class="col-12 set-text-color">
													...
													<span class="badge skill-badge set-border-color">Vercel</span>
													<span class="badge skill-badge set-border-color">Leaflet</span>
													<span class="badge skill-badge set-border-color">Tailwind CSS</span>
													<span class="badge skill-badge set-border-color">RabbitMQ</span>
													<span class="badge skill-badge set-border-color">Celery</span>
												</div>
											</div>
										</div>
										<div class="relevant-links mt-5">
											<a aria-label="web application for NCRHUB" target="_blank" href="https://www.ncrhub.org/home/">Web App</a>
										</div>
									</div>
								</div>
							</section>
							...
							<section>
								<div class="card work-cards">
									<div class="card-body set-text-color">
										...
										<h4 class="fs-6 work-time">May 2026</h4>
										<ul class="work-description">
											<li>
												An interpreter with a bytecode & AST implementation. Robert Nystrom's book, "Crafting Interpreters"
												used, but implemented in C++.
											</li>
										</ul>
										<h4 class="fs-6 work-skills-title">Skills Used...</h4>
										<div class="container-fluid p-0">
										...
										<div class="relevant-links mt-5">
											<a aria-label="github repository for cpplox" target="_blank" href="https://github.com/apoorvaparajuli0/cpplox">Repository</a>
										</div>
									</div>
								</div>
							</section>
							...
							<section>
								<div class="card work-cards">
									<div class="card-body set-text-color">
										...
										<h4 class="fs-6 work-time">August 2021-December 2021</h4>
										<ul class="work-description">
											<li>
										...
										<div class="relevant-links mt-5">
											<a aria-label="progress playlist for rue" target="_blank" href="https://www.youtube.com/playlist?list=PL9AaHbp8CL9c_1OTU7MulPUvfcQnt5t2_">Progress Videos</a>
										</div>
									</div>
								</div>
							</section>
							...
							<section>
								<div class="card work-cards">
									<div class="card-body set-text-color">
										...
										<h4 class="fs-6 work-time">January 2021-June 2021</h4>
										<ul class="work-description">
											<li>
										...
										<div class="relevant-links mt-5">
											<a aria-label="progress playlist for killer karens" target="_blank" href="https://www.youtube.com/playlist?list=PL9AaHbp8CL9c-FYMRF_XWe9SfEAcyKlCQ">Progress Videos</a>
										</div>
									</div>
								</div>
							</section>
			...
			<aside>
				<div class="bottom-nav-container position-absolute bottom-0 end-0 me-4 mb-4 position-fixed align-items-end justify-content-center">
